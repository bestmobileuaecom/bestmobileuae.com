...
import { SectionCard, InputField, TextareaField } from "../forms";
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select 
              ...
              onChange={(e) => updateField("overall_score_label", e.target.value)} 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <InputField 
            ...
            onChange={(v) => updateField("storage_options", v.split(",").map(s => s.trim()).filter(Boolean))} 
